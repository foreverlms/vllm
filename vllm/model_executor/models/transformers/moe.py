        ...
        def _recursive_replace(module: nn.Module, prefix: str):
            for child_name, child_module in module.named_children():
                ...
                if child_name == "experts" and (is_modulelist or is_3d):
                    ...
                    # Replace the forward too
                    if "nemotronvl" in self.config.architectures[0].lower():
                        from typing import Optional
                        def new_forward(self, hidden_states, padding_mask: Optional[torch.Tensor] = None):
                        ...
                        #     return self.experts(*args, **kwargs)
                        bound_method = new_forward.__get__(mlp, mlp.__class__)
